...
class PGroomingEdit extends StatefulWidget {
  final User user;
  ...
  @override
  _PGroomingEditState createState() => _PGroomingEditState();
}

class _PGroomingEditState extends State<PGroomingEdit> {
