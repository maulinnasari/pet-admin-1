...
import 'package:flutterfirebaseauth/petshop_facilities_update/edit_makanan.dart';
import 'package:flutterfirebaseauth/widget_background.dart';
import 'package:flutterfirebaseauth/app_color.dart';

class FoodUpdatePetShop extends StatefulWidget {
  final User user;
  ...
  @override
  _FoodUpdatePetShopState createState() => _FoodUpdatePetShopState();
}

class _FoodUpdatePetShopState extends State<FoodUpdatePetShop> {
              ...
              onPressed: () async {
                ...
                if (result != null && result) {
                  scaffoldState.currentState.showSnackBar(SnackBar(
                    content: Text('Food or Vitamin Have Been Added'),
                  ));
                  setState(() {});
                }
              },
                            ...
                            if (value == 'edit') {
                              ...
                              if (result != null && result) {
                                scaffoldState.currentState
                                  ...
                                  content:
                                      Text('Food or Vitamin Have Been updated'),
                                ));
                                setState(() {});
                              }
