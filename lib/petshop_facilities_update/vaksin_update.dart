...
import 'package:flutterfirebaseauth/petshop_facilities_update/edit_vaksin.dart';
import 'package:flutterfirebaseauth/widget_background.dart';
import 'package:flutterfirebaseauth/app_color.dart';

class VaksinUpdatePetShop extends StatefulWidget {
  final User user;
  ...
  @override
  _VaksinUpdatePetShopState createState() => _VaksinUpdatePetShopState();
}

class _VaksinUpdatePetShopState extends State<VaksinUpdatePetShop> {
              ...
              onPressed: () async {
                ...
                if (result != null && result) {
                  scaffoldState.currentState.showSnackBar(SnackBar(
                    content: Text('Vaccine Has Been Added'),
                  ));
                  setState(() {});
                }
              },
                            ...
                            if (value == 'edit') {
                              bool result = await Navigator.push(
                                ...
                                MaterialPageRoute(builder: (context) {
                                  return VaksinEdit(
                                    id_vks: document.reference.id,
                                    name: shop['item'],
                                    price: shop['harga'].toString(),
                                    desc: shop['desc'].toString(),
                                    user: widget.user,
                                    isEdit: true,
                                    id_shop: widget.id_shop,
                                  );
                              ...
                              if (result != null && result) {
                                scaffoldState.currentState
                                  ...
                                  content: Text('Vaccine Has Been updated'),
                                ));
                                setState(() {});
                              }
