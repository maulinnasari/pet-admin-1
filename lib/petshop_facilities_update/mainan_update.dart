...
import 'package:flutterfirebaseauth/petshop_facilities_update/edit_mainan.dart';
import 'package:flutterfirebaseauth/widget_background.dart';
import 'package:flutterfirebaseauth/app_color.dart';

class ToyUpdatePetShop extends StatefulWidget {
  final User user;
  ...
  @override
  _ToyUpdatePetShopState createState() => _ToyUpdatePetShopState();
}

class _ToyUpdatePetShopState extends State<ToyUpdatePetShop> {
              ...
              onPressed: () async {
                ...
                if (result != null && result) {
                  scaffoldState.currentState.showSnackBar(SnackBar(
                    content: Text('Toy Has Been Added'),
                  ));
                  setState(() {});
                }
              },
                            ...
                            if (value == 'edit') {
                              ...
                              if (result != null && result) {
                                scaffoldState.currentState
                                  ...
                                  content: Text('Toy Has Been updated'),
                                ));
                                setState(() {});
                              }
