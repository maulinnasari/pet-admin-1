...
class VaksinEdit extends StatefulWidget {
  final User user;
  ...
  @override
  _VaksinEditState createState() => _VaksinEditState();
}

class _VaksinEditState extends State<VaksinEdit> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 16.0),
          Text(
            widget.isEdit ? 'Edit Vaksinasi' : 'Tambah Vaksinasi',
      ...
      child: RaisedButton(
        ...
        onPressed: () async {
          ...
          if (name.isEmpty) {
            ...
            _showSnackBarMessage('Harga is required');
            return;
