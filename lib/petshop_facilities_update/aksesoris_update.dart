...
import 'package:flutterfirebaseauth/petshop_facilities_update/edit_aksesoris.dart';
import 'package:flutterfirebaseauth/widget_background.dart';
import 'package:flutterfirebaseauth/app_color.dart';

class AksesorisUpdatePetShop extends StatefulWidget {
  final User user;
  final String id_shop;

  AksesorisUpdatePetShop({
    @required this.user,
    this.id_shop,
  });

  @override
  _AksesorisUpdatePetShopState createState() => _AksesorisUpdatePetShopState();
}

class _AksesorisUpdatePetShopState extends State<AksesorisUpdatePetShop> {
                            ...
                            if (value == 'edit') {
                              bool result = await Navigator.push(
                                ...
                                MaterialPageRoute(builder: (context) {
                                  return AksesorisEdit(
                                    id_Aks: document.reference.id,
                                    name: shop['item'],
                              ...
                              if (result != null && result) {
                                scaffoldState.currentState
                                  ...
                                  content: Text('Accessories Has Been updated'),
                                ));
                                setState(() {});
                              }
